<!--PHP 7, MySQLi, AJaX, DataTables ServerSide, Bootstrap 4, dan SweetAlert-->
<?php  
            ...
            <footer class="pt-4 my-md-4 pt-md-3 border-top">
                <div class="row">
                    <div class="col-12 col-md center">
                        &copy; 2022 - <a class="text-info" href="http://dayuza.github.io/">Teguh Nugratama Dayuza</a>
                    </div>
                </div>
            </footer>
        </div>
